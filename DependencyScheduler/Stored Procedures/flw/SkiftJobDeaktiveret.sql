...
-- =============================================
CREATE PROCEDURE [flw].[SkiftJobDeaktiveret] 
...
BEGIN
	...
	-- ----- STOP: Transaction Begin -----
		...
		-- ----- 20150810 - GraKil - Kommentarfelt skal udfyldes 
		IF (@parmKommentar IS NULL) 
		BEGIN
			SET @Return		=	0
			raiserror('Fejl: Der er ikke angivet kommentar for deaktivering', 18, 1)	
		END
